...
(function (Aufgabe9) {
    ...
    let audioliste = [sound0, sound1, sound2, sound3, sound4, sound5, sound6, sound7, sound8];
    let audiomix = [sound0, sound1, sound2, sound3, sound4, sound5, sound6, sound7, sound8];
    let counter = 0;
