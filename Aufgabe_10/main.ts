namespace Aufgabe10 {
    ...
    let value = (document.getElementById("new-task-submit") as HTMLInputElement);

    let number: HTMLHeadingElement = <HTMLHeadingElement>document.getElementById("zahl")
...
window.addEventListener ('load',() =>{
    ...
    form.addEventListener ('submit', (e) =>{
       ...
       if(!task){ alert("Please add a task");
       return;}
